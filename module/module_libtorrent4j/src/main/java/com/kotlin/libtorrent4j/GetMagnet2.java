...
//        final String uri = "magnet:?xt=urn:btih:a83cc13bf4a07e85b938dcf06aa707955687ca7c";
            ...
            public void alert(Alert<?> alert) {
                ...
                if (alert.type().equals(AlertType.DHT_STATS)) {
                    ...
                    if (nodes >= 10) {
                        ...
                        LogUtils.debug("DHT contains " + nodes + " nodes");
                        signal.countDown();
                    }
                }
            }
        ...
        s.start();
        s.postDhtStats();
        LogUtils.debug("Waiting for nodes in DHT (10 seconds)...");
        ...
        LogUtils.debug("Fetching the magnet uri (multi thread), please wait...");
