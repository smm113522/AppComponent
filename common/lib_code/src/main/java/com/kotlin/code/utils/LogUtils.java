...
public final class LogUtils {
    ...
    public static final String DEBUG_TAG = "com.kotlin";// LogCat的标记
    ...
    private static boolean isDebug = DEBUG_ENABLE;// 是否调试模式
    private static String debugTag = DEBUG_TAG;// LogCat的标记
