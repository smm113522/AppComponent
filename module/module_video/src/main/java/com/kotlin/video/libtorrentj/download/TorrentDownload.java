...
package com.kotlin.video.libtorrentj.download;
...
import com.kotlin.video.libtorrentj.TorrentEngineCallback;
import com.kotlin.video.libtorrentj.bean.AdvancedPeerInfo;
import com.kotlin.video.libtorrentj.bean.MagnetInfo;
...
import com.kotlin.video.libtorrentj.storage.TorrentStorage;
import com.kotlin.video.libtorrentj.utils.FileIOUtils;
import com.kotlin.video.libtorrentj.utils.TorrentUtils;
    ...
    private void handleMetadata(byte[] bencode, String hash, String newName)
    {
        ...
        try {
            ...
            if (freeSpace < info.torrentSize)
                throw new DecodeException("Not enough free space: "
